...
const BannerDetail = ({
    ...
    const daysDifference = Math.ceil((today - releaseDate) / (1000 * 60 * 60 * 24));
    return (
        <div className='banner__contents'>
            <p className='release'>{formateDate(release_date)?.toLocaleLowerCase() || 'NA'}</p>
            ...
            <div className='banner__buttons'>
                ...
                <button className='btn black-btn' style={{ background: 'var(--black-800)' }}>
